...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const restaurants = yield Restaurant_1.Restaurant.find().populate('chef', 'name').populate('dishes');
    res.send(restaurants);
}));
router.get('/:id', validateObjectId_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const restaurant = yield Restaurant_1.Restaurant.findById(req.params.id).populate('chef', 'name').populate('dishes');
    if (!restaurant)
